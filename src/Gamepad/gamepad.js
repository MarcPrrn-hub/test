...
Gamepad.utils = {
    ...
    wrap: function (blocks) {
        ...
        for (let type of blocks) {
            ...
            switch (type) {
                // procedures wrap
                case 'procedures_defnoreturn': //ATTENTION J AI ENLEVE ; pour l erreur 
...
Gamepad.init = function (options) {
    ...
    // load the toolbox
    if (options.hasOwnProperty('toolbox')) this['TOOLBOX'] = options.toolbox;
    // load the context
