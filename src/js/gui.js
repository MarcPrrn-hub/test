...
import guiData from '../config/gui';
/* --- Gui manager --- */
//
// this class:
...
class Gui {
    constructor() {
        ...
        this.asynchronizer = new Gamepad.Asynchronizer(
            // class
            GUI,
            // run function
            function (id) {
                ...
                // set the sprite
                this.rect = document.getElementById("clipRect")
                this.pegman = document.getElementById("pegman")

                // set the sprite position
                this.rect.setAttribute('x', levels[id - 1].images.rect.x)
                this.rect.setAttribute('y', levels[id - 1].images.rect.y)
                this.pegman.setAttribute('x', levels[id - 1].images.pegman.x)
                this.pegman.setAttribute('y', levels[id - 1].images.pegman.y)
            },
            // reset function
            function () {
